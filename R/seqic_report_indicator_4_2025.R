...
readr::write_csv(
  ...
  file = "C:/Users/nfoss0/OneDrive - State of Iowa HHS/Analytics/BEMTS/SEQIC Facility Reports/2024/state/4/seqic_indicator_4_results_state.csv"
)

# state level by age reporting
readr::write_csv(
  x = seqic_indicator_4_results_state_age,
  file = "C:/Users/nfoss0/OneDrive - State of Iowa HHS/Analytics/BEMTS/SEQIC Facility Reports/2024/state/4/seqic_indicator_4_results_state_age.csv"
)

# service area level reporting
readr::write_csv(
  x = seqic_indicator_4_results_service_areas,
  file = "C:/Users/nfoss0/OneDrive - State of Iowa HHS/Analytics/BEMTS/SEQIC Facility Reports/2024/state/4/seqic_indicator_4_results_service_areas.csv"
)

# verification level reporting
readr::write_csv(
  x = seqic_indicator_4_results_verification,
  file = "C:/Users/nfoss0/OneDrive - State of Iowa HHS/Analytics/BEMTS/SEQIC Facility Reports/2024/state/4/seqic_indicator_4_results_verification.csv"
)
